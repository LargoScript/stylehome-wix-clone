...
if (-not $sshPath) {
    ...
    Write-Host "wget https://raw.githubusercontent.com/LargoScript/stylehome-wix-clone/main/deploy-vps.sh" -ForegroundColor Cyan
...
$sshCommands = @"
wget -O deploy-vps.sh https://raw.githubusercontent.com/LargoScript/stylehome-wix-clone/main/deploy-vps.sh
...
Write-Host ""
$oneLiner = "ssh deploy@31.131.21.16 'wget -O - https://raw.githubusercontent.com/LargoScript/stylehome-wix-clone/main/deploy-vps.sh | bash'"
